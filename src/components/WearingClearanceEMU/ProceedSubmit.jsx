...
const ProceedSubmitWearingClearance  = ({ formDataProceedSubmitEMUWearingClearance , setformDataProceedSubmitEMUWearingClearance  }) => {
  console.log("formDataProceedSubmitEMUWearingClearance :", formDataProceedSubmitEMUWearingClearance );
  ...
  const handleNext = async (e) => {
    ...
    try {
      ...
      if (response) {
        ...
        setformDataProceedSubmitEMUWearingClearance ((prevformDataProceedSubmitICF) => ({
        ...
        navigate("/wearingclearanceemuviewallentry");
      } else {
  ...
  const exportToExcel = async () => {
    ...
    const worksheet = workbook.addWorksheet("EMUWearingClearance");
    ...
    row4.getCell(2).value = formDataProceedSubmitEMUWearingClearance.WheelNo;
    worksheet.mergeCells(4, 4, 4, 5);
    row4.getCell(4).value = formDataProceedSubmitEMUWearingClearance.AxleNo;
    worksheet.mergeCells(4, 6, 4, 7);
    row4.getCell(6).value = formDataProceedSubmitEMUWearingClearance.WearingCodeNo;
    worksheet.mergeCells(4, 8, 4, 9);
    row4.getCell(8).value = formDataProceedSubmitEMUWearingClearance.MatungaWNo;
    row4.getCell(10).value = formDataProceedSubmitEMUWearingClearance.V;
    row4.getCell(11).value = formDataProceedSubmitEMUWearingClearance.DMA;
    row4.getCell(12).value = formDataProceedSubmitEMUWearingClearance.MA;
    worksheet.mergeCells(4, 13, 4, 14);
    row4.getCell(13).value = formDataProceedSubmitEMUWearingClearance.InitialFittings;
    worksheet.mergeCells(4, 15, 4, 16);
    row4.getCell(15).value = formDataProceedSubmitEMUWearingClearance.WearingService;
    worksheet.mergeCells(4, 17, 4, 18);
    row4.getCell(17).value = formDataProceedSubmitEMUWearingClearance.TagStatus;
    worksheet.mergeCells(4, 19, 4, 20);
    row4.getCell(19).value = formDataProceedSubmitEMUWearingClearance.FrontCover;
    worksheet.mergeCells(4, 21, 5, 22);
    row4.getCell(21).value = formDataProceedSubmitEMUWearingClearance.StaffTNo;
  
    // Second data row
    const row5 = worksheet.getRow(5);
    row5.getCell(2).value = formDataProceedSubmitEMUWearingClearance.WheelType;
    row5.getCell(3).value = formDataProceedSubmitEMUWearingClearance.WheelDiameter;
    worksheet.mergeCells(5, 4, 5, 5);
    row5.getCell(4).value = formDataProceedSubmitEMUWearingClearance.AxleYear;
    worksheet.mergeCells(5, 6, 5, 7);
    row5.getCell(6).value = formDataProceedSubmitEMUWearingClearance.WearingCodeNo;
    worksheet.mergeCells(5, 8, 5, 9);
    row5.getCell(8).value = formDataProceedSubmitEMUWearingClearance.MatungaWNo;
    row5.getCell(10).value = formDataProceedSubmitEMUWearingClearance.Make;
    row5.getCell(11).value = formDataProceedSubmitEMUWearingClearance.DMA;
    row5.getCell(12).value = formDataProceedSubmitEMUWearingClearance.MA;
    worksheet.mergeCells(5, 13, 5, 14);
    row5.getCell(13).value = formDataProceedSubmitEMUWearingClearance.InitialFittings;
    worksheet.mergeCells(5, 15, 5, 16);
    row5.getCell(15).value = formDataProceedSubmitEMUWearingClearance.WearingService;
    worksheet.mergeCells(5, 17, 5, 18);
    row5.getCell(17).value = formDataProceedSubmitEMUWearingClearance.TagStatus;
    worksheet.mergeCells(5, 19, 5, 20);
    row5.getCell(19).value = formDataProceedSubmitEMUWearingClearance.FrontCover;
...
row6.getCell(7).value = formDataProceedSubmitEMUWearingClearance.InspName;
...
row6.getCell(19).value = formDataProceedSubmitEMUWearingClearance.InspTicket;
...
[wearingCell, measurementsCell].forEach(cell => {
  cell.alignment = {
    ...
    workbook.xlsx.writeBuffer().then((buffer) => {
      ...
      saveAs(blob, "EMUWearingClearance.xlsx");
    });
  };
  ...
  const exportToPDF = () => {
    ...
    doc.save("WearingPositionReportEMU.pdf");
  };
  ...
  const rows = [
    [
      handleNullValue(formDataProceedSubmitEMUWearingClearance.IndxNo),
      formDataProceedSubmitEMUWearingClearance.WheelNo,
      handleNullValue(formDataProceedSubmitEMUWearingClearance.WheelType),
      handleNullValue(formDataProceedSubmitEMUWearingClearance.WheelDiameter),
      handleNullValue(formDataProceedSubmitEMUWearingClearance.AxleNo),
      handleNullValue(formDataProceedSubmitEMUWearingClearance.AxleYear),
      handleNullValue(formDataProceedSubmitEMUWearingClearance.WearingCodeNo),
      handleNullValue(formDataProceedSubmitEMUWearingClearance.WearingCodeYear),
      handleNullValue(formDataProceedSubmitEMUWearingClearance.MatungaWNo),
      handleNullValue(formDataProceedSubmitEMUWearingClearance.V),
      handleNullValue(formDataProceedSubmitEMUWearingClearance.Make),
      handleNullValue(formDataProceedSubmitEMUWearingClearance.DMA),
      handleNullValue(formDataProceedSubmitEMUWearingClearance.MA),
      handleNullValue(formDataProceedSubmitEMUWearingClearance.InitialFittings),
      handleNullValue(formDataProceedSubmitEMUWearingClearance.WearingService),
      handleNullValue(formDataProceedSubmitEMUWearingClearance.TagStatus),
      handleNullValue(formDataProceedSubmitEMUWearingClearance.FrontCover),
      handleNullValue(formDataProceedSubmitEMUWearingClearance.StaffTNo),
      handleNullValue(formDataProceedSubmitEMUWearingClearance.InspName),
      handleNullValue(formDataProceedSubmitEMUWearingClearance.InspTicket)
    ]
  ];
  ...
  link.setAttribute("download", "WearingPositionReportEMU.csv");
      ...
      <table>
          ...
          <tbody>
            <tr>
              ...
              <td colSpan={1}>{formDataProceedSubmitEMUWearingClearance .V}</td>
...
export default ProceedSubmitWearingClearance ;
