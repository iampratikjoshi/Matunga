...
function StatusICF({
  ...
  const handleBack = () => {
    navigate("/wearingclearanceicf/servicesbymonth");
  };
            ...
            <div className="row-1">
              <div>
                ...
                <input
                  type="text"
                  name="TagStatus"
                  value={formDataProceedSubmitICFWearingClearance .TagStatus}
              ...
              <label>
                ...
                <input
                  type="text"
                  name="FrontCover"
                  value={formDataProceedSubmitICFWearingClearance .FrontCover}
                  onChange={handleChange}
              ...
              <label>
                ...
                <input
                  type="text"
                  name="StaffTNo"
                  value={formDataProceedSubmitICFWearingClearance .StaffTNo}
                  onChange={handleChange}
            ...
            <div className="row-3">
              ...
              <label>
                ...
                <input
                  type="text"
                  name="InspName"
                  value={formDataProceedSubmitICFWearingClearance .InspName}
                  onChange={handleChange}
              ...
              <label>
                ...
                <input
                  type="text"
                  name="InspTicket"
                  value={formDataProceedSubmitICFWearingClearance .InspTicket}
                  onChange={handleChange}
              ...
              <div>
                <button
                  onClick={() => {
                      ...
                      navigate("/proceedsubmiticfwearingclearance");
