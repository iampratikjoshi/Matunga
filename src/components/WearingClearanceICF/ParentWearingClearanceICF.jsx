...
import ProceedSubmitWearingClearanceICF  from "./ProceedSubmit";
import WearingClearance from "./WearingClearance";

function ParentWearingClearanceICF() {
  const [formDataProceedSubmitICFWearingClearance , setformDataProceedSubmitICFWearingClearance ] = useState({
    WheelNo: "",
    AxleNo: "",
    ATLNo: "",
    WheelSeatSize: "",
  ...
  return (
    ...
    <Routes>
      ...
      <Route
        ...
        element={
          <ProceedSubmitWearingClearanceICF  formDataProceedSubmitICFWearingClearance ={formDataProceedSubmitICFWearingClearance } setformDataProceedSubmitICFWearingClearance ={setformDataProceedSubmitICFWearingClearance } />
        }
      />
      <Route path="/wearingclearanceicfviewallentry" element={<AllEntryWearingClearance  />} />
    </Routes>
    //   </Router>
  );
}

export default ParentWearingClearanceICF;
