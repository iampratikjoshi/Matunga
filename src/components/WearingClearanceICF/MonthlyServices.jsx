...
function MonthlyServicesICF({
  ...
  const saveandcontinue = () => {
    onNextStep();
    navigate("/wearingclearanceicf/status");
  };
            ...
            <div className="row-1">
              <div>
                ...
                <input
                  ...
                  value={formDataProceedSubmitICFWearingClearance .InitialFittings}
              ...
              <div>
                ...
                <input
                  type="text"
                  name="WearingService"
                  value={formDataProceedSubmitICFWearingClearance .WearingService}
                  onChange={handleChange}
            ...
            <div className="row-3">
              ...
              {/* <label>Remark:</label>
                <input
                  type="text"
                  name="Remark"
                  // value={formDataProceedSubmitICFWearingClearance .EndHole}
                  // onChange={handleChange}
...
export default MonthlyServicesICF;
