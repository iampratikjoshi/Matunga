...
function SidebarWearingClearanceICF() {
  ...
  const SidebarData = [
    ...
    { title: "Monthly Services", link: "servicesbymonth" },
    { title: "Status", link: "status" },
  ];

  const handleLinkClick = (link) => {
    setActiveLink("/wearingclearanceicf/" +link);
  };
          ...
          {SidebarData.map((val, key) => {
            return (
              <li
                ...
                className={
                  activeLink === "/wearingclearanceicf/" + val.link
                    ? "active"
                    : "inactive"
                }
              >
...
export default SidebarWearingClearanceICF;
