...
const ProceedSubmit = ({ formDataScheduleEMU, setFormDataScheduleEMU }) => {
  ...
  const handleNext = async (e) => {
    ...
    try {
      const response = await postData("/emu/preinsp/data", formDataScheduleEMU);
...
//     [..."ABCDEFGHIJKLMNOPQRSTUVWXYZ", "AA", "AB", "AC"].forEach(col => {
//       worksheet.getColumn(col).width = 15;
//     });
...
//     worksheet.mergeCells("C9:C10");
//     worksheet.mergeCells("C11:C12");
//     worksheet.mergeCells(9, 4, 10, 29);
//     worksheet.mergeCells(11, 4, 12, 29);
//     worksheet.mergeCells(13, 1, 16, 2);
//     worksheet.mergeCells(13, 4, 14, 29);
//     worksheet.mergeCells("C13:C14");
//     worksheet.mergeCells("C15:C16");
...
//       "Y1", "Z1", "AA1",
//       "A3", "B3", "C3", "E3", "G3", "I3",
//       "A9", "A13", "A17", "C9", "C11", "C13", "C15","C17","C19"
//     ];
...
//       "A1", "B1", "B3", "D1", "D3", "E1", "E3", "G1", "G3", "H1", "H3", "I1", 
//       "I3", "F1", "C1", "J1", "K1", "L1", "M1", "N1", "O1", "P1", "Q1", "R1", 
//       "S1", "T1", "U1", "V1", "A3", "C3", "E3", "G3", "I3", "A9", "A18", "C18", 
//       "E18", "A13", "C9", "C11", "C13", "C15", "W1", "X1", "Y1", "Z1", "AA1", 
//       "AB1", "AC1", "A17", "A19","A23","C23","E23"
//     ];
...
// };
  ...
  //       { content: handleNullValue(formDataScheduleEMU.DiscParticularA), colSpan: 30 }, // Data for Disc Particular A
  //     ],
  //     [
  //       { content: "B" }, // Subheader B
  //       { content: handleNullValue(formDataScheduleEMU.DiscParticularB), colSpan: 30 }, // Data for Disc Particular B
  //     ],
