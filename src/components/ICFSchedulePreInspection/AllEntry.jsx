...
const AllEntry = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await api.get("/icf/preinsp/getalldata");
  ...
  //     worksheet.mergeCells(currentRow + 8, 4, currentRow + 9, 26);
  //     worksheet.mergeCells(currentRow + 10, 4, currentRow + 11, 26);
  ...
  const exportToCSV = () => {
    ...
    link.setAttribute("download", "ICFSchedulePreInspection.csv");
    ...
    <div className="main_div">
      <div className="button_div">
        ...
        <button
          ...
          onClick={() => navigate("/icfschedulepreinspectionform/w1_details")}
        >
          ...
          {data.map((res) => (
            <tbody name="tbody" key={`tbody-${res.id}`}>
              ...
              <tr>
                ...
                <th colSpan="">A</th>
                <td colSpan="25">{res.DiscParticularA}</td>
              </tr>
              <tr>
                <th rowSpan="" colSpan="">
                  B
                </th>
                <td colSpan="25">{res.DiscParticularB}</td>
              </tr>
              {/* <tr>
              <th rowSpan="2" colSpan={2}>
