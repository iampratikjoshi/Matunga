...
const ProceedSubmit = ({ formDataScheduleICF, setFormDataScheduleICF }) => {
  ...
  const handleNext = async (e) => {
    ...
    try {
      const response = await postData("/icf/preinsp/data", formDataScheduleICF);
  ...
  //     // Handle merged cells separately to ensure their borders are visible
  //     worksheet.mergeCells.forEach(range => {
  //       const startCell = worksheet.getCell(range.start.row, range.start.col);
  //       startCell.border = {
  //         top: { style: 'thin', color: { argb: '000000' } },
  //         left: { style: 'thin', color: { argb: '000000' } },
  //         bottom: { style: 'thin', color: { argb: '000000' } },
  ...
  //   ];
  //   worksheet.getRow(7).values = [formDataScheduleICF.AxleNumber, formDataScheduleICF.AxleCondition];
