...
const ProceedSubmitPressOff = ({
  ...
  const handleNext = async (e) => {
    ...
    try {
      const response = await api.put("/emupressoff/editdata/" + formDataPressOffEMU.wheelid, formDataPressOffEMU); // Use putData for updating
  ...
  const exportToExcel = async () => {
    ...
    // Add header rows
    worksheet.addRow({
      Date: formDataPressOffEMU.Date,
      OperatorName: formDataPressOffEMU.OperatorName,
      OperatorTNo: formDataPressOffEMU.OperatorTNo,
      InspectorName: formDataPressOffEMU.InspectorName,
      InspectorTNo: formDataPressOffEMU.InspectorTNo,
      ShopSNo: formDataPressOffEMU.ShopSNo,
      MachineNumber: formDataPressOffEMU.MachineNumber,
      ShiftNumber: formDataPressOffEMU.ShiftNumber,
      TypeOfWheel: formDataPressOffEMU.TypeOfWheel,
      WheelPressedOff: formDataPressOffEMU.WheelPressedOff,
      DiscSrNo: formDataPressOffEMU.DiscSrNo,
      GeneralObservation: formDataPressOffEMU.AxleNo,
      AxleNo: formDataPressOffEMU.Reason,
      Reason: formDataPressOffEMU.AxleCondition,
      AxleCondition: formDataPressOffEMU.AxleConditionReason,
      AxleConditionReason: formDataPressOffEMU.AxleConditionCause,
      AxleConditionCause: formDataPressOffEMU.BrakeDiscCondition,
      BrakeDiscCondition: formDataPressOffEMU.BrakeDiscConditionReason,
      BrakeDiscConditionReason: formDataPressOffEMU.BrakeDiscConditionCause,
      BrakeDiscConditionCause: formDataPressOffEMU.WheelDiscCondition,
      WheelDiscCondition: formDataPressOffEMU.WheelConditionReason,
      WheelConditionReason: formDataPressOffEMU.WheelDiscConditionCause,
      WheelDiscConditionCause: formDataPressOffEMU.serviceablediscidnumber,
      serviceablediscidnumber: formDataPressOffEMU.PressedOffRemark,
  ...
  const exportToPDF = () => {
    ...
    const tableRows = [
      [
        formDataPressOffEMU.Date,
        formDataPressOffEMU.OperatorTNo,
        formDataPressOffEMU.OperatorName,
        formDataPressOffEMU.InspectorTNo,
        formDataPressOffEMU.InspectorName,
        formDataPressOffEMU.ShopSNo,
        formDataPressOffEMU.MachineNumber,
        formDataPressOffEMU.ShiftNumber,
        formDataPressOffEMU.TypeOfWheel,
        formDataPressOffEMU.WheelPressedOff,
        formDataPressOffEMU.DiscSrNo,
        formDataPressOffEMU.AxleNo,
        formDataPressOffEMU.Reason,
        formDataPressOffEMU.AxleCondition,
        formDataPressOffEMU.AxleConditionReason,
        formDataPressOffEMU.AxleConditionCause,
        formDataPressOffEMU.BrakeDiscCondition,
        formDataPressOffEMU.BrakeDiscConditionReason,
        formDataPressOffEMU.BrakeDiscConditionCause,
        formDataPressOffEMU.WheelDiscCondition,
        formDataPressOffEMU.WheelConditionReason,
        formDataPressOffEMU.WheelDiscConditionCause,
        formDataPressOffEMU.serviceablediscidnumber,
        formDataPressOffEMU.PressedOffRemark,
    ...
    <div className="main_div">
      ...
      <div id="table-container">
        <table>
          ...
          <tbody>
            <tr>
              <td rowSpan="2">{formDataPressOffEMU.Date}</td>
              <td rowSpan="2">{formDataPressOffEMU.OperatorName}</td>
              <td rowSpan="2">{formDataPressOffEMU.OperatorTNo}</td>
              <td rowSpan="2">{formDataPressOffEMU.InspectorName}</td>
              <td rowSpan="2">{formDataPressOffEMU.InspectorTNo}</td>
              <td rowSpan="2">{formDataPressOffEMU.ShopSNo}</td>
              <td rowSpan="2">{formDataPressOffEMU.MachineNumber}</td>
              <td rowSpan="2">{formDataPressOffEMU.ShiftNumber}</td>
              <td rowSpan="2">{formDataPressOffEMU.TypeOfWheel}</td>
              <td rowSpan="2">{formDataPressOffEMU.WheelPressedOff}</td>
              <td rowSpan="2">{formDataPressOffEMU.DiscSrNo}</td>
              <td colSpan={1}>{formDataPressOffEMU.AxleNo}</td>
              <td colSpan={1}>{formDataPressOffEMU.Reason}</td>

              <td colSpan={1}>{formDataPressOffEMU.AxleCondition}</td>
              <td colSpan={1}>{formDataPressOffEMU.AxleConditionReason}</td>
              <td colSpan={1}>{formDataPressOffEMU.AxleConditionCause}</td>
              <td colSpan={1}>{formDataPressOffEMU.BrakeDiscCondition}</td>
              <td colSpan={1}>
                {formDataPressOffEMU.BrakeDiscConditionReason}
              </td>
              <td colSpan={1}>{formDataPressOffEMU.BrakeDiscConditionCause}</td>

              <td colSpan={1}>{formDataPressOffEMU.WheelDiscCondition}</td>
              <td colSpan={1}>{formDataPressOffEMU.WheelConditionReason}</td>
              <td colSpan={1}>{formDataPressOffEMU.WheelDiscConditionCause}</td>
              <td colSpan={1}>{formDataPressOffEMU.serviceablediscidnumber}</td>

              <td rowSpan="2">{formDataPressOffEMU.PressedOffRemark}</td>
            </tr>
          </tbody>
        </table>
      </div>
