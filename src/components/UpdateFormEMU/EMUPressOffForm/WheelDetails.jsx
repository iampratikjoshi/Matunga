...
function WheelDetails({ formDataPressOffEMU, setFormDataPressOffEMU, onInputChange,
  onNextStep,
  onResetStep, }) {
  ...
  const handleBack = () => {
    navigate("/parentemuedit/UpdateEMUPressOffForm/wheelcondition_details");
  };
  ...
  const saveandcontinue = () => {
    onNextStep();
    navigate("/parentemuedit/UpdateEMUPressOffForm/inspector_details");
  };
            ...
            <div className="Pressonoffrow-1">
              <div>
                ...
                <input
                  type="text"
                  name="TypeOfWheel"
                  value={formDataPressOffEMU.TypeOfWheel}
              ...
              <div>
                ...
                <input
                  ...
                  value={formDataPressOffEMU.WheelPressedOff}
                  onChange={handleChange}
              ...
              <div>
                ...
                <input
                  type="text"
                  name="Reason"
                  value={formDataPressOffEMU.Reason}
                  onChange={handleChange}
            ...
            <div className="Pressonoffrow-2">
              <div>
                ...
                <input
                  ...
                  value={formDataPressOffEMU.PressedOffRemark}
                  onChange={handleChange}
