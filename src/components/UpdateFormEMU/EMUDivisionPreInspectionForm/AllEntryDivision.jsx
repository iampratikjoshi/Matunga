...
const AllEntryDivision = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await api.get("/emu/division/getalldata");
    ...
    <div className="main_div">
      <div className="button_div">
        ...
        <button
          ...
          onClick={() => navigate("/EMUDivisionPreInspectionForm/wheel_details")}
        >
          Add New Entry
        </button>
        <button
          className="yellow-button"
          onClick={() => navigate("/EMUSchedulePreInspection/details")}
        >
