...
function CTRBDetailsB({
  ...
  const handleCancel = () => {
    ...
    onResetStep();
    navigate("/UpdateEMUSchedulePreInspectionForm/w1_details");
  };

  const handleBack = () => {
    setIsBackNavigation(true); // Set flag when navigating back
    navigate("/UpdateEMUSchedulePreInspectionForm/ctrba_details");
  };
  ...
  const saveandcontinue = () => {
    ...
    navigate("/UpdateEMUSchedulePreInspectionForm/repair_details");
  };
