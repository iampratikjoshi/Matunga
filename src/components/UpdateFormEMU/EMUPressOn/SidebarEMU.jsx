...
function SidebarEMU() {
  ...
  const SidebarData = [
    { title: "Details", link: "emu_details" },
  ...
  const handleLinkClick = (link) => {
    setActiveLink("/parentemuedit/UpdateEMUPressOn/" +link);
  };
          ...
          {SidebarData.map((val, key) => {
            return (
              <li
                ...
                className={
                  activeLink === "/parentemuedit/UpdateEMUPressOn/" + val.link
                    ? "active"
                    : "inactive"
                }
              >
