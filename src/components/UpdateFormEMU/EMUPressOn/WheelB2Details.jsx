...
function WheelB2({
  ...
  const back = () => {
    navigate("/parentemuedit/UpdateEMUPressOn/wheel_b1_details");
  };
            ...
            <div className="Pressonoffrow-1">
              ...
              <label>
                ...
                <input
                  type="text"
                  name="BTopX"
                  value={formDataProceedSubmitEMU.BTopX}
              ...
              <label>
                ...
                <input
                  type="text"
                  name="BTopY"
                  value={formDataProceedSubmitEMU.BTopY}
                  onChange={handleChange}
            ...
            <div className="Pressonoffrow-3">
              ...
              <label>
                ...
                <input
                  type="text"
                  name="BMiddleX"
                  value={formDataProceedSubmitEMU.BMiddleX}
                  onChange={handleChange}
              ...
              <label>
                ...
                <input
                  type="text"
                  name="BMiddleY"
                  value={formDataProceedSubmitEMU.BMiddleY}
                  onChange={handleChange}
            ...
            <div className="Pressonoffrow-2">
              ...
              <label>
                ...
                <input
                  type="text"
                  name="BLowerX"
                  value={formDataProceedSubmitEMU.BLowerX}
                  onChange={handleChange}
              ...
              <label>
                ...
                <input
                  type="text"
                  name="BLowerY"
                  value={formDataProceedSubmitEMU.BLowerY}
                  onChange={handleChange}
            ...
            <div className="Pressonoffrow-3">
              ...
              <label>
                ...
                <input
                  type="text"
                  name="BAvgX"
                  value={formDataProceedSubmitEMU.BAvgX}
                  onChange={handleChange}
              ...
              <label>
                ...
                <input
                  type="text"
                  name="BAvgY"
                  value={formDataProceedSubmitEMU.BAvgY}
                  onChange={handleChange}
