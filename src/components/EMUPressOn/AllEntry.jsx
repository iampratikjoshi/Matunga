...
const AllEntryPressOnEMU = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await api.get("/emu/presson/getalldata");
  ...
  const exportToExcel = async () => {
    ...
    const worksheet = workbook.addWorksheet("EMUPressOn");
    ...
    data.forEach((formDataProceedSubmitEMU, index) => {
      ...
      worksheet.getCell(`B${currentRow}`).value = formDataProceedSubmitEMU.WheelNo;
      ...
      worksheet.getCell(`E${currentRow}`).value = formDataProceedSubmitEMU.WheelType;
      ...
      worksheet.getCell(`I${currentRow}`).value = formDataProceedSubmitEMU.AxleNo;
      ...
      worksheet.getCell(`A${currentRow + 4}`).value = formDataProceedSubmitEMU.ATLNo;
      ...
      worksheet.getCell(`D${currentRow + 4}`).value = formDataProceedSubmitEMU.AWheelSide;
      worksheet.mergeCells(`D${currentRow + 6}:E${currentRow + 7}`);
      worksheet.getCell(`D${currentRow + 6}`).value = formDataProceedSubmitEMU.BWheelSide;
      ...
      worksheet.getCell(`G${currentRow + 4}`).value = formDataProceedSubmitEMU.ARASide;
      worksheet.mergeCells(`G${currentRow + 6}:H${currentRow + 7}`);
      worksheet.getCell(`G${currentRow + 6}`).value = formDataProceedSubmitEMU.BRASide;
      ...
      worksheet.getCell(`I${currentRow + 4}`).value = formDataProceedSubmitEMU.OperatorNamePrimary
      ...
      // and before the "Wheel Disc 'A' Side" section
        ...
        // For header "Wheel Activities"
          ...
          // For the value from formDataProceedSubmitEMU
          worksheet.mergeCells(`G${currentRow + 8}:K${currentRow + 8}`);
          worksheet.getCell(`G${currentRow + 8}`).value = formDataProceedSubmitEMU.WheelActivities;
         ...
         if (formDataProceedSubmitEMU.WheelActivities === "RA" || 
            ...
            worksheet.getCell(`A${currentRow + 10}`).value = formDataProceedSubmitEMU.AxleWheelSeatSize;

            // Wheel Disc Bore Size value
            worksheet.mergeCells(`D${currentRow + 10}:F${currentRow + 10}`);
            worksheet.getCell(`D${currentRow + 10}`).value = formDataProceedSubmitEMU.WheelDiscBoreSize;

            // Wheel Disc Stamping Particulars value
            worksheet.mergeCells(`G${currentRow + 10}:I${currentRow + 10}`);
            worksheet.getCell(`G${currentRow + 10}`).value = formDataProceedSubmitEMU.wheelDiscStampingParticulars;

            // Press On Number value
            worksheet.mergeCells(`J${currentRow + 10}:K${currentRow + 10}`);
            worksheet.getCell(`J${currentRow + 10}`).value = formDataProceedSubmitEMU.PressOnNumber;
            ...
            worksheet.getCell(`A${currentRow + 10}`).value = formDataProceedSubmitEMU.InspectorNameActivities;

            // Ticket No value
            worksheet.mergeCells(`F${currentRow + 10}:K${currentRow + 10}`);
            worksheet.getCell(`F${currentRow + 10}`).value = formDataProceedSubmitEMU.TicketNo;
            ...
            // Ticket No value
            worksheet.mergeCells(`A${currentRow + 10}:E${currentRow + 10}`);
            worksheet.getCell(`A${currentRow + 10}`).value = formDataProceedSubmitEMU.TicketNo;

            // Operator No value
            worksheet.mergeCells(`F${currentRow + 10}:K${currentRow + 10}`);
            worksheet.getCell(`F${currentRow + 10}`).value = formDataProceedSubmitEMU.OperatorNo;
          }
    ...
    worksheet.getRow(currentRow + 13).alignment = {
      ...
      worksheet.getCell(`A${currentRow + 15}`).value = formDataProceedSubmitEMU.VTLNo;

      // Bore size value
      worksheet.mergeCells(`C${currentRow + 15}:E${currentRow + 15}`);
      worksheet.getCell(`C${currentRow + 15}`).value = formDataProceedSubmitEMU.BoreSize;

      // RA Value value
      worksheet.mergeCells(`F${currentRow + 15}:H${currentRow + 15}`);
      worksheet.getCell(`F${currentRow + 15}`).value = formDataProceedSubmitEMU.RAValue;

      // Operator Name value
      worksheet.mergeCells(`I${currentRow + 15}:K${currentRow + 15}`);
      worksheet.getCell(`I${currentRow + 15}`).value = formDataProceedSubmitEMU.OperatorNameA;
      ...
      // X Values
      worksheet.getCell(`B${currentRow + 18}`).value = formDataProceedSubmitEMU.TopX;
      worksheet.getCell(`B${currentRow + 19}`).value = formDataProceedSubmitEMU.MiddleX;
      worksheet.getCell(`B${currentRow + 20}`).value = formDataProceedSubmitEMU.LowerX;
      worksheet.getCell(`B${currentRow + 21}`).value = formDataProceedSubmitEMU.AvgX;

      // Y Values
      worksheet.getCell(`C${currentRow + 18}`).value = formDataProceedSubmitEMU.TopY;
      worksheet.getCell(`C${currentRow + 19}`).value = formDataProceedSubmitEMU.MiddleY;
      worksheet.getCell(`C${currentRow + 20}`).value = formDataProceedSubmitEMU.LowerY;
      worksheet.getCell(`C${currentRow + 21}`).value = formDataProceedSubmitEMU.AvgY;

      // B Wheel Seat Size value - merged vertically
      worksheet.mergeCells(`D${currentRow + 17}:D${currentRow + 21}`);
      worksheet.getCell(`D${currentRow + 17}`).value = formDataProceedSubmitEMU.BWheelSeatSize;

      // C-B-A Int Allow value - merged vertically
      worksheet.mergeCells(`E${currentRow + 17}:E${currentRow + 21}`);
      worksheet.getCell(`E${currentRow + 17}`).value = formDataProceedSubmitEMU.CBAIntAllow;

      // Pressure In Ton value - merged vertically
      worksheet.mergeCells(`F${currentRow + 17}:G${currentRow + 21}`);
      worksheet.getCell(`F${currentRow + 17}`).value = formDataProceedSubmitEMU.PressureInTon;

      // RD No value - merged vertically
      worksheet.mergeCells(`H${currentRow + 17}:H${currentRow + 21}`);
      worksheet.getCell(`H${currentRow + 17}`).value = formDataProceedSubmitEMU.RDNo;

      // Wheel Disc Particulars value - merged vertically
      worksheet.mergeCells(`I${currentRow + 17}:K${currentRow + 21}`);
      worksheet.getCell(`I${currentRow + 17}`).value = formDataProceedSubmitEMU.WheelDiscAParticulars;
      ...
      worksheet.getCell(`A${currentRow + 27}`).value = formDataProceedSubmitEMU.VTLNoB;

      worksheet.mergeCells(`C${currentRow + 27}:E${currentRow + 27}`);
      worksheet.getCell(`C${currentRow + 27}`).value = formDataProceedSubmitEMU.BoreSizeB;

      worksheet.mergeCells(`F${currentRow + 27}:H${currentRow + 27}`);
      worksheet.getCell(`F${currentRow + 27}`).value = formDataProceedSubmitEMU.RAValueB;

      worksheet.mergeCells(`I${currentRow + 27}:K${currentRow + 27}`);
      worksheet.getCell(`I${currentRow + 27}`).value = formDataProceedSubmitEMU.OperatorNameB;
      ...
      worksheet.getCell(`B${currentRow + 30}`).value = formDataProceedSubmitEMU.BTopX;
      worksheet.getCell(`C${currentRow + 30}`).value = formDataProceedSubmitEMU.BTopY;
      worksheet.getCell(`B${currentRow + 31}`).value = formDataProceedSubmitEMU.BMiddleX;
      worksheet.getCell(`C${currentRow + 31}`).value = formDataProceedSubmitEMU.BMiddleY;
      worksheet.getCell(`B${currentRow + 32}`).value = formDataProceedSubmitEMU.BLowerX;
      worksheet.getCell(`C${currentRow + 32}`).value = formDataProceedSubmitEMU.BLowerY;
      worksheet.getCell(`B${currentRow + 33}`).value = formDataProceedSubmitEMU.BAvgX;
      worksheet.getCell(`C${currentRow + 33}`).value = formDataProceedSubmitEMU.BAvgY;
      ...
      worksheet.getCell(`D${currentRow + 29}`).value = formDataProceedSubmitEMU.BWheelSeatSizeB;
      worksheet.mergeCells(`E${currentRow + 29}:E${currentRow + 33}`);
      worksheet.getCell(`E${currentRow + 29}`).value = formDataProceedSubmitEMU.CBAIntAllowB;
      worksheet.mergeCells(`F${currentRow + 29}:G${currentRow + 33}`);
      worksheet.getCell(`F${currentRow + 29}`).value = formDataProceedSubmitEMU.PressureInTonB;
      worksheet.mergeCells(`H${currentRow + 29}:H${currentRow + 33}`);
      worksheet.getCell(`H${currentRow + 29}`).value = formDataProceedSubmitEMU.RDNoB;
      worksheet.mergeCells(`I${currentRow + 29}:K${currentRow + 33}`);
      worksheet.getCell(`I${currentRow + 29}`).value = formDataProceedSubmitEMU.WheelDiscAParticularsB;
  ...
  return (
    <div className="main_div">
      ...
      <div id="table-container">
        {data.map((formDataProceedSubmitEMU) => (
          <table key={formDataProceedSubmitEMU.id}>
...
export default AllEntryPressOnEMU;
