...
function WheelB3({
  ...
  const saveandcontinue = () => {
    onNextStep();
    navigate("/emu_presson/operator_details");
  };

  const back = () => {
    navigate("/emu_presson/wheel_b2_details");
  };
            ...
            <div className="Pressonoffrow-1">
              <div>
                ...
                <input
                  ...
                  value={formDataProceedSubmitEMU.BWheelSeatSizeB}
              ...
              <div>
                ...
                <input
                  type="text"
                  name="CBAIntAllowB"
                  value={formDataProceedSubmitEMU.CBAIntAllowB}
                  onChange={handleChange}
              ...
              <label>
                ...
                <input
                  type="text"
                  name="PressureInTonB"
                  value={formDataProceedSubmitEMU.PressureInTonB}
                  onChange={handleChange}
            ...
            <div className="Pressonoffrow-3">
              ...
              <label>RD No:</label>
                <input
                  type="text"
                  name="RDNoB"
                  value={formDataProceedSubmitEMU.RDNoB}
                  onChange={handleChange}
              ...
              <label>
                ...
                <input
                  ...
                  value={formDataProceedSubmitEMU.WheelDiscAParticularsB}
                  onChange={handleChange}
