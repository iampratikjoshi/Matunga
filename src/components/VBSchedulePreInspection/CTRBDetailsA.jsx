...
function CTRBDetailsA({
  ...
  const [ctrbdefectA, setctrbdefectA] = useState(formDataVB.CTRBDefectA);
  const [CTRBDefectNameA, setCTRBDefectNameA] = useState(
    formDataVB.CTRBDefectNameA
  );
  const [CTRBRemarkA, setRemarkA] = useState(formDataVB.CTRBRemarkA);
  ...
  const [CTRBStatusA, setCTRBStatusA] = useState(formDataVB.CTRBStatusA);
  const [RefurbishmentDetailsA, setRefurbishmentDetailsA] = useState(
    formDataVB.RefurbishmentDetailsA
  );

  const [CTRBMakeA, setCTRBMakeA] = useState(formDataVB.CTRBMakeA); // State for CTRBMakeA dropdown
  ...
  const handleCTRBDefectANameChange = (event) => {
    ...
    console.log(formDataVB.CTRBDefectNameA);
  };
  ...
  const handleRefurbishmentDetailsA = (event) => {
    ...
    console.log(formDataVB.RefurbishmentDetailsA);
  };
  ...
  const handleOtherCTRBMakeAChange = (event) => {
    ...
    console.log(formDataVB.CTRBMakeA);
  };
  ...
  const handleBack = () => {
    ...
    navigate("/VBSchedulePreInspection/bdandcoach_details");
  };
  ...
  return (
    <div className="componentPreInspection">
      ...
      <h2>CTRB A Details for VB PRE Inspection Form</h2>
            ...
            <div className="PreInspectionrow-2">
              ...
              <div>
                ...
                <input
                  ...
                  value={formDataVB.CTRBRemainingLifeA}
