...
function BDAndCoachDetails({
  ...
  const [BDDefect, setBDDefect] = useState(formDataVB.BDDefect); // State for BDDefect dropdown
  const [OtherBDDefect, setOtherBDDefect] = useState(""); // State for other BDDefect input

  const [BDMakeIN, setBDMakeIN] = useState(formDataVB.BDMakeIN); // State for CTRBMakeB dropdown
  ...
  const handleOtherBDDefectChange = (event) => {
    ...
    console.log(formDataVB.BDDefect);
  };
  ...
  const handleOtherBDMakeINChange = (event) => {
    ...
    console.log(formDataVB.BDMakeIN);
  };
  ...
  const saveandcontinue = () => {
    ...
    navigate("/VBSchedulePreInspection/ctrba_details");
  };
  ...
  return (
    <div className="componentPreInspection">
      ...
      <h2>BD And COACH Details for VB PRE Inspection Form</h2>
