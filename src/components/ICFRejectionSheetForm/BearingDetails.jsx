...
function BearingDetails({
  ...
  const saveandcontinue = () => {
      ...
      onNextStep();
      navigate("/icfrejectionsheetform/report_details");
  ...
  return (
    <div className="component">
      ...
      <h2> Bearing Details For ICF Bearing Rejection Sheet Form</h2>
          ...
          <div className="wheel-page-main-content">
            <div className="row-1">
              <div>
                ...
                <input
                  type="text"
                  name="BearingNo"
                  value={formDataRejectionSheetICF.BearingNo}
              ...
              <div>
                ...
                <input
                  type="text"
                  name="Make"
                  value={formDataRejectionSheetICF.Make}
                  onChange={handleChange}
              ...
              <div>
                ...
                <input
                  ...
                  value={formDataRejectionSheetICF.CodeorYearofMFG}
                  onChange={handleChange}
            ...
            <div>
                ...
                <input
                  ...
                  value={formDataRejectionSheetICF.DateofRejection}
                  onChange={handleChange}
                />
