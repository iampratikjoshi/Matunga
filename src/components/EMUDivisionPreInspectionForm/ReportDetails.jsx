...
function ReportDetails({
  ...
  const handleDivisionNameChange = (event) => {
    ...
    if (selectedRemark !== "others") {
      ...
      setFormDataDivisionEMU((prevData) => ({
        ...prevData,
  ...
  const handleOtherDivisionNameChange = (event) => {
    ...
    console.log(formDataDivisionEMU.DivisionName);
  };
  ...
  const handleOtherDivisionReportChange = (event) => {
    ...
    console.log(formDataDivisionEMU.divisionreport);
  };
  ...
  const handleChange = (event) => {
    ...
    // console.log(formDataDivisionEMU);
  };
  ...
  const handleCancel = () => {
    ...
    onResetStep();
    navigate("/emudivisionpreinspectionform/wheel_details");
  };
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    let wheelNo = formDataDivisionEMU.WheelNo;
  ...
  return (
    <div className="componentPreInspection">
      ...
      <h2>Report Details For EMU Division Pre Inspection Form</h2>
          ...
          <div className="wheel-page-main-PreInspection-content">
            <div className="PreInspectionrow-1">
              <div>
                ...
                <input
                  type="date"
                  name="POHDate"
                  value={formDataDivisionEMU.POHDate}
            ...
            <div className="PreInspectionrow-2">
              ...
              <div>
                ...
                <input
                  type="text"
                  name="matungareport"
                  value={formDataDivisionEMU.matungareport}
                  onChange={handleChange}
            ...
            <div className="PreInspectionrow-3">
              <div>
                ...
                <input
                  type="text"
                  name="Remark"
                  // value={formDataDivisionEMU.EndHole}
                  // onChange={handleChange}
            ...
            <div className="btn-containerPreInspection">
              ...
              <div>
                <button
                  onClick={() => {
                    navigate("/emuschedulepreinspectionform/wheel_details");
                  }}
                >
                  Back
                </button>
