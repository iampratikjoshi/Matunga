...
const ProceedSubmitDivision = ({ formDataDivisionEMU, setFormDataDivisionEMU }) => {
  const handleNext = async (e) => {
    e.preventDefault();

    try {
      const response = await postData("/emu/division/data", formDataDivisionEMU);
      ...
      if (response) {
        ...
        navigate("/viewallentryEMUDivision");
      } else {
  ...
  const exportToExcel = async () => {
    ...
    const worksheet = workbook.addWorksheet("EMUDivisionPreInspectionForm");
    ...
    worksheet.addRow({
      ...
      WheelNo: formDataDivisionEMU.WheelNo,
      LooryNo: formDataDivisionEMU.LooryNo,
      POHDate: formDataDivisionEMU.POHDate,
      // returndate: formDataDivisionEMU.returndate,
      divisionreport: formDataDivisionEMU.divisionreport,
      DivisionName: formDataDivisionEMU.DivisionName,
    });
    ...
    saveAs(blob, "EMUDivisionPreInspectionForm.xlsx");
  };
  ...
  const exportToPDF = () => {
    ...
    const tableRows = [
      [
        ...
        formDataDivisionEMU.WheelNo,
        formDataDivisionEMU.LooryNo,
        formDataDivisionEMU.POHDate,
        // formDataDivisionEMU.returndate,
        formDataDivisionEMU.divisionreport,
        formDataDivisionEMU.DivisionName,
      ],
    ];
    ...
    doc.autoTable({
      ...
      didDrawPage: (data) => {
        ...
        if (data.pageNumber === 1) {
          doc.setFontSize(12);
          doc.text(
            "EMU Division Pre Inspection Form Report",
    ...
    doc.save("EMUDivisionPreInspectionForm.pdf");
  };
  ...
  const exportToCSV = () => {
    ...
    const rows = [
      [
        ...
        formDataDivisionEMU.divisionreport,
        formDataDivisionEMU.DivisionName,
        formDataDivisionEMU.matungareport,
      ],
    ];
    ...
    link.setAttribute("download", "EMUDivisionPreInspectionForm.csv");
    ...
    <div className="main_div">
      ...
      <div id="table-container">
        <table>
          ...
          <tbody>
            <tr>
              <td rowSpan="2">{formDataDivisionEMU.WheelNo}</td>
              <td rowSpan="2">{formDataDivisionEMU.LooryNo}</td>
              <td rowSpan="2">{formDataDivisionEMU.POHDate}</td>
              <td rowSpan="2">{formDataDivisionEMU.divisionreport}</td>
              <td rowSpan="2">{formDataDivisionEMU.DivisionName}</td>
              <td rowSpan="2">{formDataDivisionEMU.matungareport}</td>
            </tr>
          </tbody>
        </table>
      </div>
