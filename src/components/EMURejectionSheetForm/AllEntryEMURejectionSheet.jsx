...
const AllEntryEMURejectionSheet = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await api.get("/bearingrejectionemu/getalldata");
  ...
  const exportToExcel = async () => {
    ...
    const worksheet = workbook.addWorksheet("EMURejectionSheet");
    ...
    saveAs(blob, "EMURejectionSheet.xlsx");
  };
  ...
  const exportToPDF = () => {
    ...
    doc.save("EMURejectionSheet.pdf");
  };
  ...
  const exportToCSV = () => {
    ...
    link.setAttribute("download", "EMURejectionSheet.csv");
    ...
    <div className="main_div">
      <div className="button_div">
        ...
        <button
          ...
          onClick={() => navigate("/emurejectionsheetform/bearing_details")}
        >
          Add New Entry
        </button>
        {/* <button
...
export default AllEntryEMURejectionSheet;
