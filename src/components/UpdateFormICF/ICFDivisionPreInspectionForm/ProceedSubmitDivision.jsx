...
const ProceedSubmitDivision = ({ formDataICFDivision, setFormDataICFDivision }) => {
  const handleNext = async (e) => {
    e.preventDefault();

    try {
      const response = await postData("/inward/data", formDataICFDivision);
      ...
      if (response) {
        ...
        navigate("/viewallentryICFDivision");
      } else {
  ...
  const exportToExcel = async () => {
    ...
    const worksheet = workbook.addWorksheet("ICFDivisionPreInspectionForm");
    ...
    worksheet.addRow({
      ...
      WheelNo: formDataICFDivision.WheelNo,
      LooryNo: formDataICFDivision.LooryNo,
      POHDate: formDataICFDivision.POHDate,
      // returndate: formDataICFDivision.returndate,
      divisionreport: formDataICFDivision.divisionreport,
      DivisionName: formDataICFDivision.DivisionName,
    });
    ...
    saveAs(blob, "ICFDivisionPreInspectionForm.xlsx");
  };
  ...
  const exportToPDF = () => {
    ...
    const tableRows = [
      [
        ...
        formDataICFDivision.WheelNo,
        formDataICFDivision.LooryNo,
        formDataICFDivision.POHDate,
        // formDataICFDivision.returndate,
    ...
    doc.autoTable({
      ...
      didDrawPage: (data) => {
        ...
        if (data.pageNumber === 1) {
          doc.setFontSize(12);
          doc.text(
            "ICF Division Pre Inspection Form Report",
    ...
    doc.save("ICFDivisionPreInspectionForm.pdf");
  };
  ...
  const exportToCSV = () => {
    ...
    const rows = [
      [
        ...
        formDataICFDivision.divisionreport,
        formDataICFDivision.DivisionName,
        formDataICFDivision.matungareport,
      ],
    ];
    ...
    link.setAttribute("download", "ICFDivisionPreInspectionForm.csv");
    ...
    <div className="main_div">
      ...
      <div id="table-container">
        <table>
          ...
          <tbody>
            <tr>
              <td rowSpan="2">{formDataICFDivision.WheelNo}</td>
              <td rowSpan="2">{formDataICFDivision.LooryNo}</td>
              <td rowSpan="2">{formDataICFDivision.POHDate}</td>
              <td rowSpan="2">{formDataICFDivision.divisionreport}</td>
              <td rowSpan="2">{formDataICFDivision.DivisionName}</td>
              <td rowSpan="2">{formDataICFDivision.matungareport}</td>
            </tr>
          </tbody>
        </table>
      </div>
