...
function SidebarLHB() {
  ...
  const SidebarData = [
    { title: "Wheel Details - 1", link: "w1_details" },
    { title: "Wheel Details - 2", link: "w2_details" },
    
    { title: "BRG Details", link: "brg_details" },
    // { title: "Radical Clearance", link: "repair_details" },
    { title: "Repair Details", link: "repair_details" },
    
  ];

  const handleLinkClick = (link) => {
    setActiveLink("/parentediticf/UpdateICFSchedulePreInspection/" +link);
  };
          ...
          {SidebarData.map((val, key) => {
            return (
              <li
                ...
                className={
                  activeLink === "/parentediticf/UpdateICFSchedulePreInspection/" + val.link
                    ? "active"
                    : "inactive"
                }
              >
