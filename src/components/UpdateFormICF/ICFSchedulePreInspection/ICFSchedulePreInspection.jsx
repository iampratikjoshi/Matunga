...
import CTRBDetailsA from "./BrgDetails.jsx";
...
function ICFUpdatedSchedulePreInspection({ formDataScheduleICF, setFormDataScheduleICF }) {
  // State for stepper
...
export default ICFUpdatedSchedulePreInspection;
