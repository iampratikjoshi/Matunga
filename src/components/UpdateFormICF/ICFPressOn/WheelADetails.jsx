...
function WheelA1({
  ...
  const back = () => {
    navigate("/parentediticf/UpdateICFPressOnForm/wheel_activities");
  };
            ...
            <div className="Pressonoffrow-1">
              <div>
                ...
                <input
                  type="text"
                  name="VTLNo"
                  value={formDataProceedSubmitPressOnICF.VTLNo}
              ...
              <div>
                ...
                <input
                  type="text"
                  name="BoreSize"
                  value={formDataProceedSubmitPressOnICF.BoreSize}
                  onChange={handleChange}
              ...
              <label>
                ...
                <input
                  type="text"
                  name="RAValue"
                  value={formDataProceedSubmitPressOnICF.RAValue}
                  onChange={handleChange}
            ...
            <div className="Pressonoffrow-3">
              ...
              <label>
                ...
                <input
                  type="text"
                  name="OperatorNameA"
                  value={formDataProceedSubmitPressOnICF.OperatorNameA}
                  onChange={handleChange}
