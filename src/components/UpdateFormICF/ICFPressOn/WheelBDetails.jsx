...
function WheelB1({
  ...
  const saveandcontinue = () => {
    onNextStep();
    navigate("/parentediticf/UpdateICFPressOnForm/wheel_b2_details");
  };
            ...
            <div className="Pressonoffrow-1">
              <div>
                ...
                <input
                  type="text"
                  name="VTLNoB"
                  value={formDataProceedSubmitPressOnICF.VTLNoB}
              ...
              <div>
                ...
                <input
                  type="text"
                  name="BoreSizeB"
                  value={formDataProceedSubmitPressOnICF.BoreSizeB}
                  onChange={handleChange}
              ...
              <label>
                ...
                <input
                  type="text"
                  name="RAValueB"
                  value={formDataProceedSubmitPressOnICF.RAValueB}
                  onChange={handleChange}
            ...
            <div className="Pressonoffrow-3">
              ...
              <label>
                ...
                <input
                  type="text"
                  name="OperatorNameB"
                  value={formDataProceedSubmitPressOnICF.OperatorNameB}
                  onChange={handleChange}
