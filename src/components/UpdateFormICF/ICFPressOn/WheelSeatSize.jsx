...
function WheelSeatSize({
  ...
  const saveandcontinue = () => {
    onNextStep();
    navigate("/parentediticf/UpdateICFPressOnForm/ra_value");
  };
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
      ...
      try {
        const response = await api.put("/icfpresson/editdata/"+ formDataProceedSubmitPressOnICF.wheelid , formDataProceedSubmitPressOnICF);
...
{" "}
      ...
      <h2>Wheel Seat Size By Operator</h2>
            ...
            <div className="Pressonoffrow-1">
              <div>
                ...
                <input
                  type="text"
                  name="AWheelSide"
                  value={formDataProceedSubmitPressOnICF.AWheelSide}
              ...
              <div>
                ...
                <input
                  type="text"
                  name="BWheelSide"
                  value={formDataProceedSubmitPressOnICF.BWheelSide}
                  onChange={handleChange}
