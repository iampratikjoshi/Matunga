...
import SidebarICF from "./SidebarICF.jsx";

function UpdateICFPressOn({ formDataProceedSubmitPressOnICF, setformDataProceedSubmitPressOnICF }) {
  // State for stepper
...
export default UpdateICFPressOn;
