...
function InspectorDetails({ formDataPressOffICF, setFormDataPressOffICF, onInputChange,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await api.put("/icfpressoff/editdata/"+ formDataPressOffICF.wheelid , formDataPressOffICF);
        ...
        <div className="page-contentPressOnoff">
          <div className="wheel-page-main-pressonoff-content">
            ...
            <div className="btn-containerPressonoff">
              ...
              <div>
                <button onClick={() => { navigate("/parentediticf/updateproceedsubmitpressoff") }}>
