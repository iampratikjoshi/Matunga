...
function BRGDetailsB({
  ...
  const saveandcontinue = () => {
      ...
      onNextStep();
      navigate("/parentediticf/UpdateICFfinalinspection/details");
    
  };

  const handleBack = () => {
    // Set flag when navigating back
    navigate("/parentediticf/UpdateICFfinalinspection/Brg_detailsA");
  };
  ...
  return (
    <div className="componentFinal">
      ...
      <h2>BRG Details B for ICF Final Inspection Form</h2>
          ...
          <div className="wheel-page-main-final-content">
            ...
            <div>
                ...
                <input
                  type="text"
                  name="BrgCodeB"
                  value={formDataFinalICF.BrgCodeB}
              ...
              <div>
                ...
                <input
                  type="text"
                  name="BrgYearB"
                  value={formDataFinalICF.BrgYearB}
                  onChange={handleChange}
              ...
              <div>
                ...
                <input
                  type="text"
                  name="MTNBrgNoB"
                  value={formDataFinalICF.MTNBrgNoB}
                  onChange={handleChange}
            ...
            <div>
                ...
                <input
                  type="text"
                  name="BrgMakeB"
                  value={formDataFinalICF.BrgMakeB}
                  onChange={handleChange}
            ...
            <div>
                ...
                <input
                  ...
                  value={formDataFinalICF.RadialClearanceDismountedB}
                  onChange={handleChange}
            ...
            <div>
                ...
                <input
                  ...
                  value={formDataFinalICF.RadialClearanceMountedB}
                  onChange={handleChange}
            ...
            <div>
                ...
                <input
                  ...
                  value={formDataFinalICF.BrgInitialFitmentMonthB}
                  onChange={handleChange}
            ...
            <div>
                ...
                <input
                  ...
                  value={formDataFinalICF.BrgServiceInMonthB}
                  onChange={handleChange}
