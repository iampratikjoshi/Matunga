...
function WheelA3({
  ...
  const saveandcontinue = () => {
    onNextStep();
    navigate("/icf_presson/wheel_b1_details");
  };

  const back = () => {
    navigate("/icf_presson/wheel_a2_details");
  };
            ...
            <div className="Pressonoffrow-1">
              <div>
                ...
                <input
                  type="text"
                  name="BWheelSeatSize"
                  value={formDataProceedSubmitPressOnICF.BWheelSeatSize}
              ...
              <div>
                ...
                <input
                  type="text"
                  name="CBAIntAllow"
                  value={formDataProceedSubmitPressOnICF.CBAIntAllow}
                  onChange={handleChange}
              ...
              <label>
                ...
                <input
                  type="text"
                  name="PressureInTon"
                  value={formDataProceedSubmitPressOnICF.PressureInTon}
                  onChange={handleChange}
            ...
            <div className="Pressonoffrow-3">
              ...
              <label>RD No:</label>
                <input
                  type="text"
                  name="RDNo"
                  value={formDataProceedSubmitPressOnICF.RDNo}
                  onChange={handleChange}
              ...
              <label>
                ...
                <input
                  ...
                  value={formDataProceedSubmitPressOnICF.WheelDiscAParticulars}
                  onChange={handleChange}
