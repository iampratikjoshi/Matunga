...
const AllEntryDivisionVB = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await api.get("/vb/division/getalldata");
    ...
    <div className="main_div">
      <div className="button_div">
        ...
        <button
          ...
          onClick={() => navigate("/VBDivisionPreInspectionForm/wheel_details")}
        >
          Add New Entry
        </button>
        <button
          className="yellow-button"
          onClick={() => navigate("/VBSchedulePreInspection/details")}
        >
...
export default AllEntryDivisionVB;
