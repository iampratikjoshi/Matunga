...
function WheelDetails({
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        if (wheelid) {
          const response = await api.get(`/vbdivision/getdata/`+wheelid); // Assuming your API needs the wheelid in the endpoint
  ...
  }, [WheelNo,wheelid, setFormDataDivisionVB]);
  ...
  const handleCancel = () => {
    ...
    onResetStep();
    navigate("/parenteditvb/UpdateVBDivisionPreInspectionForm/wheel_details");
  };
  ...
  const saveandcontinue = () => {
    ...
    onNextStep();
    navigate("/parenteditvb/UpdateVBDivisionPreInspectionForm/report_details");
