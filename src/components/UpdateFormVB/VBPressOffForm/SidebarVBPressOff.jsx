...
// import "../../resources/VB/lhbpressoffform/lhbpressoffform.css";
import { HiMenuAlt4, HiX } from "react-icons/hi";
import { motion } from "framer-motion";
import "../../../resources/LHB/preInspectionform/proceedsubmit.css";

function SidebarVBPressOff() {
  ...
  const SidebarData = [
    ...
    { title: "Wheel Condition Details", link: "wheelcondition_details" },
    { title: "Wheel Details", link: "wheel_details" },
    { title: "Inspector Details", link: "inspector_details" },
  ];

  const handleLinkClick = (link) => {
    setActiveLink("/parenteditvb/UpdateVBPressOffForm/" +link);
  };
          ...
          {SidebarData.map((val, key) => {
            return (
              <li
                ...
                className={
                  activeLink === "/parenteditvb/UpdateVBPressOffForm/" + val.link
                    ? "active"
                    : "inactive"
                }
              >
...
export default SidebarVBPressOff;
