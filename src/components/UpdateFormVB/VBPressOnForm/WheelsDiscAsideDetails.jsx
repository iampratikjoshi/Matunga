...
function WheelsDiscAsideDetails({
  ...
  const handleBack = () => {
    navigate("/parenteditvb/UpdateVBPressOnForm/wheeldiscABoresize_details");
  };
  ...
  const saveandcontinue = () => {
    ...
    onNextStep();
    navigate("/parenteditvb/UpdateVBPressOnForm/wheeldiscBBoresize_details");
  ...
  return (
    <div className="componentPressonoff">
      ...
      <h2>Wheel Disc A Side Details for PRESS-ON OF VB WHEEL Form</h2>
            ...
            <div className="Pressonoffrow-1">
              <div>
                ...
                <input
                  ...
                  value={formDataPressOnVB.WheelDiscAVTLNO}
              ...
              <div>
                ...
                <input
                  ...
                  value={formDataPressOnVB.WheelDiscABoreSizeByOperator}
                  onChange={handleChange}
              ...
              <div>
                ...
                <input
                  ...
                  value={formDataPressOnVB.WheelDiscARAValue}
                  onChange={handleChange}
            ...
            <div className="Pressonoffrow-2">
              <div>
                ...
                <input
                  ...
                  value={formDataPressOnVB.WheelDiscAOperatorName}
                  onChange={handleChange}
              ...
              <div>
                ...
                <input
                  ...
                  value={formDataPressOnVB.WheelDiscABWheelSeatSize}
                  onChange={handleChange}
              ...
              <div>
                ...
                <input
                  ...
                  value={formDataPressOnVB.WheelDiscAAllow}
                  onChange={handleChange}
            ...
            <div className="Pressonoffrow-3">
              <div>
                ...
                <input
                  ...
                  value={formDataPressOnVB.WheelDiscAPressOnPressure}
                  onChange={handleChange}
              ...
              <div>
                ...
                <input
                  type="text"
                  name="WheelDiscARDNo"
                  value={formDataPressOnVB.WheelDiscARDNo}
                  onChange={handleChange}
              ...
              <div>
                ...
                <input
                  ...
                  value={formDataPressOnVB.WheelDiscAWheelDiscParticulars}
                  onChange={handleChange}
