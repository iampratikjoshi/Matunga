...
function SidebarVB() {
  ...
  const SidebarData = [
    ...
    {
      title: "Wheel Disc B Side Bore Size",
      link: "wheeldiscBBoresize_details",
    },
  ...
  const handleLinkClick = (link) => {
    setActiveLink("/parenteditvb/UpdateVBPressOnForm/" + link);
  };
          ...
          {SidebarData.map((val, key) => {
            return (
              <li
                ...
                className={
                  activeLink === "/parenteditvb/UpdateVBPressOnForm/" + val.link
                    ? "active"
                    : "inactive"
                }
              >
