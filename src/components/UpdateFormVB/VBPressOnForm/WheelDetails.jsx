...
function WheelDetails({
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        if (wheelid) {
          const response = await api.get(`/vbpresson/getdata/` + wheelid); // Assuming your API needs the wheelid in the endpoint
  ...
  const saveandcontinue = () => {
    ...
    onNextStep();
    navigate("/parenteditvb/UpdateVBPressOnForm/wheelactivities_details");
